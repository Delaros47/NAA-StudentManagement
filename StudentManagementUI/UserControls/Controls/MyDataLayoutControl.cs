...
namespace StudentManagementUI.UserControls.Controls
{
    ...
    internal class MyLayoutControlImplementor : LayoutControlImplementor
    {
        ...
        public override LayoutGroup CreateLayoutGroup(LayoutGroup parent)
        {
            ...
            //Now Since manually Table Mode creates us two Columns that we will create the third one by ourselves with Absolute (fixed Width 100)
            ...
            group.OptionsTableLayoutGroup.ColumnDefinitions.Add(new ColumnDefinition { SizeType=SizeType.Absolute,Width=100});
            ...
            for (int i = 1; i <= 10; i++)
            {
                group.OptionsTableLayoutGroup.RowDefinitions.Add(new RowDefinition { SizeType=SizeType.Absolute,Height=24});
                if (i+1!=10)
                {
                    continue;
                }
